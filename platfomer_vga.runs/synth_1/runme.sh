...
HD_PWD='C:/Users/Waylon/Desktop/Code/platfomer_vga/platfomer_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log platfomer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source platfomer_top.tcl
