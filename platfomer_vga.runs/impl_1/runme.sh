...
HD_PWD='C:/Users/Waylon/Desktop/Code/platfomer_vga/platfomer_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log platfomer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source platfomer_top.tcl -notrace
